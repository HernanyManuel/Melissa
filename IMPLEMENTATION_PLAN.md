...
Fonte: `SPECIFICATION.md`, secções 0–135, commit `c2324fe76dd5d8ec6a426403068fd8b50e2f0a3d`. Estado: Phase 0 documentada; implementação funcional pendente. A especificação e a estrutura original permanecem inalteradas.
